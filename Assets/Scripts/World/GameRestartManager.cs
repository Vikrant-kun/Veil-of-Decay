...
public class GameRestartManager : MonoBehaviour
{
    ...
    [HideInInspector] public Transform currentPlayerTransform; // exposed but hidden in Inspector
    ...
    void Awake()
    {
        ...
        if (playerPrefab != null)
        {
            ...
            else
            {
                ...
                DontDestroyOnLoad(existingPlayer);
    ...
    void Start()
    {
        ...
        {
            Debug.Log("GameRestartManager: Game started normally or not from death. Enabling player controls.");
    ...
    private IEnumerator PlayGuardianAngelCinematic()
    {
        ...
        {
            Debug.LogWarning("GameRestartManager: Guardian Angel Prefab or Player Transform not assigned. Cinematic skipped.");
        }
